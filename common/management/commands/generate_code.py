...
from common.code_generator.analyzer import get_app
from common.code_generator.generator import Generator
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        Generator(
            ...
            template_path=os.path.join(settings.BASE_DIR, 'common', 'code_generator', 'templates')
        ).make_all()
